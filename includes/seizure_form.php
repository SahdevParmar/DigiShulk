...
<div class="page">
    <div class="card" style="max-width: 900px;">
        ...
        <nav aria-label="Seizure report steps" style="display: flex; justify-content: center; margin-bottom: var(--space-8); position: relative;">
            <div style="position: absolute; top: calc(50% + 20px); left: 0; right: 0; height: 9px; background: var(--color-border); transform: translateY(-50%); z-index: 1;" aria-hidden="true"></div>
